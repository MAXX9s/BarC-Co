...
public class Main {
	...
	public static void main(String[] args) {
		...
		admin nico = new admin(2,"Nico", "111", LocalDate.of(2005, 9, 25), 2222, "french 2930", "nico@davinci.edu.ar", "Admin");
		...
		usuarios.add(new admin(2,"Nico", "111", LocalDate.of(2005, 9, 25), 2222, "french 2930", "Administrador", "nico@davinci.edu.ar"));
